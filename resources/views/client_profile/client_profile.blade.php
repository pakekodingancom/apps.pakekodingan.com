                ...
                <div class="col-md-12">
                    <div class="card border-0 mb-4 no-bg">
                        <div class="card-header py-3 px-0 d-flex align-items-center  justify-content-between border-bottom">
                            ...
                            <a href="{{ url('clients') }}" class="btn btn-dark ms-1"><i class="icofont-arrow-left me-2 fs-6"></i>Back</a>
                        </div>
                    </div>
                </div>
            </div><!-- Row End -->
                                                ...
                                                <div class="task-info d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="task-priority d-flex flex-column align-items-center justify-content-center">
                                                        <div class="avatar-list avatar-list-stacked m-0">
                                                            <img class="avatar rounded-circle small-avt sm" src="{{ asset('assets/images/xs/avatar2.jpg') }}" alt="">
                                                            <img class="avatar rounded-circle small-avt sm" src="{{ asset('assets/images/xs/avatar1.jpg') }}" alt="">
                                                        </div>
                                        ...
                                        <li class="dd-item mb-3">
                                            <div class="dd-handle">
                                                <div class="task-info d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="task-priority d-flex flex-column align-items-center justify-content-center">
                                                        <div class="avatar-list avatar-list-stacked m-0">
                                                            <img class="avatar rounded-circle small-avt sm" src="{{ asset('assets/images/xs/avatar7.jpg') }}" alt="">
                                                        </div>
...
@section('JsCustom')
    @include('client_profile/js_client_profile')
@endsection