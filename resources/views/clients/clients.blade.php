                        ...
                        <div class="card-body  d-flex">
                            ...
                            <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                                ...
                                <div class="d-flex flex-wrap align-items-center ct-btn-set">
                                    ...
                                    <a href="{{ url('clients/profile') }}" class="btn btn-dark btn-sm mt-1"><i class="icofont-invisible me-2 fs-6"></i>Profile</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('JqueryCoreJs')
    <script src="{{ asset('assets/bundles/ourclients/libscripts.bundle.js') }}"></script>
@endsection
